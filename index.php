...
<div id="portfolio" class="portfolio">
   <div class="top-tours-head text-center">
	      ...
	      <ul id="filters" class="clearfix wow bounceIn" data-wow-delay="0.4s">
			...
			<li><span class="filter" data-filter="app">Axum Travel</span></li>
			<li><span class="filter" data-filter="card">Awash Travel</span></li>
			<li><span class="filter" data-filter="icon">Semen Travel</span></li>
			<li><span class="filter" data-filter="fun">Harara Travel</span></li>
	        </ul>
		  ...
		  <div class="contact-grids">
			  <div class="container">
				  <div class="col-md-4 address">
						<h4 style="color:#09F"> Discover Ethiopia Tours </h4>
						<p style="color:#000">NEED HELP BOOKING PACKAGE<br/>
                        For fantastic suggestions you may also call our travel expert</p>
						<h5 style="color:#000"><span class="img1"></span>(+251) 911511391 &nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;(+251) 930216906 </h5>
						<h5 style="color:#000"><span class="img2"></span><a href="#">Tekaligne471@gmail.com&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;</a></h5>
						<h5 style="color:#000"><span class="img3"></span>Addis Ababa, Ethiopia.</h5>
                        <br/>
