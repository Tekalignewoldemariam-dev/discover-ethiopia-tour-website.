...
Important Note: This is a dynamic PHP/MySQL website. GitHub Pages only hosts static sites, so the live demo is hosted on InfinityFree (free PHP hosting).
...
Here's exactly how all my files are organized:

discover-ethiopia-tour-website/

│
├── 📄 index.php # Homepage (HTML + PHP)
├── 📄 about.php # About Ethiopia page
...
│ ├── 🖼️ banner.jpg # Homepage banner
│ ├── 🖼️ background.jpg # Background images
│ │
│ ├── 📁 tours/ # Tour destination images
│ │ ├── lalibela.jpg
│ │ ├── axum.jpg
│ │ ├── gondar.jpg
│ │ ├── simien-mountains.jpg
│ │ └── danakil.jpg
│ │
...
│ ├── 📄 header.php # Header (HTML + PHP)
│ ├── 📄 footer.php # Footer (HTML + PHP)
│ ├── 📄 navigation.php # Navigation menu (HTML + CSS classes)
...
│
├── 📁 admin/ # ADMIN PANEL
│ ├── 📄 dashboard.php # Admin dashboard (HTML + PHP)
│ ├── 📄 manage-tours.php # Manage tour packages
│ ├── 📄 manage-bookings.php # View/edit bookings
│ ├── 📄 login.php # Admin login (HTML + PHP)
│ │
...
│
├── 📁 sql/ # DATABASE
│ └── 💾 travel.sql # Complete MySQL database export
│
